...
![Measured copper in the AEP-001 bounding box over time, one panel per compartment (cod liver, blue mussel, coastal water, sediment) in native units with a free y-axis per panel. Water and sediment points carry their M-608 quality class (Background / Good / Poor / Very Poor; copper skips M-608 Class III); cod and mussel sit on a separate above/below-PROREF scale. Dashed grey line is a linear fit where n >= 6 (an eyeball of trend, not a model); faint horizontal lines are PROREF or the M-608 class boundaries; the dotted vertical marks 2024. Strip text names the sample groups present.](figures/fig07-aep1-timeseries.png){#fig-a001-timeseries}
...
![Measured copper in the AEP-002 bounding box over time, as in @fig-a001-timeseries. The box is small and the data mostly pre-2016: two Kogel cod and two Kogel mussel samples, and Sternal 2017 plus Vannmiljo sediment cores spanning Background to Very Poor. Coastal water has no data.](figures/fig09-aep2-timeseries.png){#fig-a002-timeseries}
