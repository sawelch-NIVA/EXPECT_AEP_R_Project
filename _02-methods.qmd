...
TODO: Add line of evidence for thresholds
...
tibble::tribble(
  ~Col1                   , ~Col2                                                                                                                                , ~Col3 ,
  "Sternal et al. (2017)" , "Sediment cores and historical reconstruction of sediment contamination patterns in Repparfjord"                                     , ""    ,
  "Kogel et al (2026)"    , "Analysis of copper in fish and other marine species in inner Repparfjord, mid-Repparfjord, and Revsbotn (reference fjord to North)" , ""    ,
  ""                      , ""                                                                                                                                   , ""
) |>
  flextable::flextable() |>
...
In addition, data were extracted from the Norwegian Environment Agency (NEA, Miljødirektoratet in Norwegian-language sources) database Vannmiljø ("Aquatic Environment", Vm) based on the following search criteria (@tbl-vm-search):
...
In addition Norske Utslippe reports modelled copper emissions per aquaculture facilitity. 
...
TODO: Add panel for aquaculture data
...
Of the n current or former aquaculture facilities in Hammerfest kommune, m report modelled copper emissions from antifoulant use per year. 
- We need more details on sources, modelling
- Probably take a yearly mean for the whole area
- Need to cite 2024 screening report to understand transport
- Probably to express as a yearly mean flux to sediment and/or freshwater
...
Because of the localised nature of heavy metal pollution and the different primary sources of copper in the Inner Repparfjord compared to Hammerfest and the 
...
- No species groups seem to be special drivers of overall species sensitiviity 
