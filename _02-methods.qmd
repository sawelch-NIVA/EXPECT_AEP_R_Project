...
tibble::tribble(
  ...
  "Systematic Literature Review"      , "Exposure (concentrations)"                           , ""        , "Matrix KES, Tissue KES"        , ""                                                                                                                                                                                                                                        ,
  ...
  "Copper Emissions"                  , "Emissions (mass/time)"                               , ""        , "Emissions KTR"                 , "Data resolution/quality generally lower than matrix concentrations"                                                                                                                                                                      ,
  "Copper PRTR"                       , "Mass Balance (mass/time)"                            , ""        , "Source KES"                    , "As above"                                                                                                                                                                                                                                ,
  "Aquaculture Registry"              , "Facility location and size"                          , ""        , "Source KES"                    , "Variation in size units make comparison difficult. No direct evidence of copper emission from aquaculture, but co-location of aquaculture facilities and data from aquaculture monitoring campaigns considered as evidence of pollution" ,
...
A systematic literature review framework was adapted elements of the PRISMA2020 framework (@pagePRISMA2020Statement2021). As PRISMA2020 is primarily concerned with intervention-based studies, some work was required to adapt to the scope and exigencies of an ecotoxicological exposure assessment. Additionally, the decision was made mid-review to diverge from the PRISMA2020 guidelines to complete the review within a reasonable period of time.
...
8. What level of detail were methodologies reported to (c.f. (Di Paolo et al., 2024))?
```

Based on these criteria, an subjective score between 5 (most useful) and 1 (least useful) was assigned to each study. As all scoring was conducted by a single reviewer, no inter-reviewer statistics were calculated and no calibration was conducted.

#### Data Extraction & Validation

Concentration data were extracted from study full texts using the eData application and structured data format [@welchEDataToolFormat2026]. For a full description of methodology, we direct readers to the cited paper. In short, data were extracted by a reviewer from PDFs using the Claude Sonnet 4 LLM into a structure format [@anthropic2024extracting_json], visually inspected and validated by same reviewer, and exported as a collection of comma-separated values. Data were subsequently checked for internal consistency and correctness to format with the eData format's validation functions, and combined into a single large table.
...
Where any of these criteria were met, distributions and outliers were inspected manually for potential causes. Where errors were identified as being introduced during extraction/conversion, these were removed.
...
#| fig-width: 5.2
#| fig-height: 3.4
#| fig-caption: "Sales (tonnes) of copper, tralopyril and zinc pyrithone in antifouling applications in aquaculture in Norway, 2018-2024. Data from [@norwegianenvironmentagencyBiociderSomBrukes2025]"
...
Waste is subject to primary/mechanical treatment and discharged via pipe into the Sorøysundet at a depth of 50-60m [@norwegianenvironmentagencyNorskeUtslippRenseanlegg2026]. No reporting or estimation of copper discharge to the environment is provided for Rossmolla, nor indeed for any similarly-sized WWTPs anywhere in Finnmark or Nordland. Consequently, the decision was made to use data for Kvalvikodden WWTP in Bodø, also a primary treatment plant discharging to marine receiving waters. Kvalvikodden reports copper emissions for 2021 - 2025. 2025's data were discarded as apparently incomplete at the time of reporting, and a mean (80.15 kg) calculated for 2021-2025. This mean was then adjusted for the population differential (10,488 / 49,780 connected population), giving an average yearly emission from WWTP of 16.89 kg/year [@statisticsnorway13144WastewaterPipelines2026]. Given the geography of the area and primary treatment, it seems likely that much of copper deposited in Hammerfest kommune quickly reaches marine receiving waters, but without more specific assessment WWTP emissions provide a first-order estimate.

### Other Runoff Sources

@comberSourcesCopperEuropean2023 identify a number of other sources of copper emissions to water bodies at the EU27 level: agricultural inputs to land (manure, sewage sludge application to fields, copper-based pesticides and fertilisers), atmospheric deposition, transport emissions (principally break wear but also rail and road), natural emissions from soil loss, antifoulants on marine transport, and septic tank emissions to water. Because many of these were calculated at the EU27 level (and some are not relevant to Hammerfest kommune, which has no trains, minimal land-based agriculture, but a proportionally larger aquaculture sector), it was not practical to estimate their contributions to aquatic copper loads within the AEP systems. Consequently, these sources were included (where relevant) as source KES with unquantified embedded copper or copper emissions.
...
Evidence quality for each KES and KTR in a was assessed and scored according to the entity's Essentiality, Plausibility, Evidence, and Quantitative Understanding (abbreviated to EPEQ), based on the AOP WoE assessment guidelines [@oecdUsersHandbookSupplement2018] adapted by @pengAggregateExposurePathways2022. These criteria are summarised in @tbl-woe-criteria.
