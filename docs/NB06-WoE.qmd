...
Our starting point is [@hardyGuidanceUseWeight2017]. At time of writing - and probably now too - WoE is very ad hoc. [@agerstrandWeightEvidenceEvaluation2016] identified EFSA as the only EU institution doing WoE at time of writing... is this still true?
...
Some vocab. Literature can be white, grey, or black:

-   White: Scientific literature. Indexed and published.
-   Grey: Institutional reports, datasets, etc. Generally public, but not well indexed.
-   Black: Private government or commercial literature.
...
Any kind of WoE assessment is likely to involve comparing different types of data. [@hardyGuidanceUseWeight2017] cites [@linkovWeightofevidenceEvaluationEnvironmental2009]'s ranking of WoE approaches, from worst to best:
...
![Figure copy-pasted from Peng et al. Will replace once I work out what it is I want here.](images/paste-1.png)

This allows them to make very nice diagrams:

![But it also presents us with a bit of a quandary - how do we capture this level of detail for KTRs and not just KERs, when most of our data is about occurrence?](images/paste-2.png)
...
$$
\text{CREED Score} = \frac{\text{Reliability Score + Relevance Score}}{10}
$$ {#1}
...
Here is a plot of pieces of evidence we have so far. The points are a bit wobbly and confusing right now, but I'll work on it.
