...
#| echo: true
data_validation$campaign |> eDataDRF::pb_validate_campaign() |> interrogate()
...
#| echo: true
data_validation$reference |> eDataDRF::pb_validate_reference() |> interrogate()
...
#| echo: true
data_validation$sites |> eDataDRF::pb_validate_sites() |> interrogate()
```
