...
There are some rather improbable changes here. We'll proceed as follows:
- Remove the big drop for products/aquatic 2009 - 2012
- Remove the big increase for landfill/aquatic 2009 - 2011
- Keep the suspect increase of products/atmospheric from 0 to ~1e3 (it's suspicious, but I don't have a good reason to assume that nothing happened here)
