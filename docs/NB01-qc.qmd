...
agent <-
  ...
  col_schema_match(
    col_schema(eDataDRF::initialise_measurements_tibble()),
...
# scan_data(literature_measurements_data) # has problems with µ
```
...
agent_sites <-
  ...
  col_schema_match(
    col_schema(eDataDRF::initialise_sites_tibble()),
...
agent_references <-
  ...
  col_schema_match(
    col_schema(eDataDRF::initialise_references_tibble()),
...
biota_schema <- col_schema(
  eDataDRF::initialise_biota_tibble() |>
    mutate(
      across(contains("DATE"), as.IDate),
      source_file = NA_character_,
      read_timestamp = NA_character_
