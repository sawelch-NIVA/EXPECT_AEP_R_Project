...
vm_campaign_2025 <- fread("data/clean/Vm_Unzipped/campaign.csv")
vm_sites_2025 <- fread("data/clean/Vm_Unzipped/sites.csv")
...
# Fuck it
vm_merged_data <- vm_merged_data |> mutate(SAMPLING_DATE = as.IDate("2025-01-01"))
# for fuck's sake

# I give up. 
data <- literature_merged_data |> bind_rows(vm_merged_data)
