...
config <- list(
  # File paths
  files = list(
    vm_copper = "data/raw/vannmiljo/Vm_Copper_2025.12.05.xlsx",
    vm_sites_1 = "data/raw/vannmiljo/Vm_Copper_Sites_2025.12.05-1.xlsx",
    vm_sites_2 = "data/raw/vannmiljo/Vm_Copper_Sites_2025.12.05-2.xlsx",
    vm_sites_3 = "data/raw/vannmiljo/Vm_Copper_Sites_2025.12.05-3.xlsx",
    lookup_medium = "data/clean/Vm_medium_lookup_matrix_filled.csv",
    lookup_vannkategori = "data/clean/vm_sites_codes_lookup.csv",
    lookup_methods = "data/clean/vm_methods_lookup_filled.csv",
    methods_analysis = "data/raw/vannmiljo/Vannmiljø_Analysemetode_2025-12-15.xlsx",
    methods_sampling = "data/raw/vannmiljo/Vannmiljø_Prøvetakingsmetode_2025-12-15.xlsx"
  ),
...
# Convert tibble to tribble code
...
# Get categorical summary of data.table columns
...
vm_lookup_vannkategori_raw <- read_csv(config$files$lookup_vannkategori)
...
vm_lookup_methods <- read_csv(config$files$lookup_methods) |>
  mutate(
...
# - Dates: 2025-01-01 to 2025-12-05
#
# Excluded (~43% of data):
...
sanity_map <- ggplot(world_map) +
  geom_map(
    data = world_map,
    map = world_map,
    aes(long, lat, map_id = region)
  ) +
  geom_sf(data = sites_sf, colour = "red", size = 0.5) +
  coord_sf(xlim = c(4, 32), ylim = c(58, 72)) +
  labs(title = "Vannmiljø Freshwater Sites 2025")
...
initialise_sites_tibble() |> add_row(edata_sites)
